...
const TRANSLATIONS = {
  fr: {
    ...
    // Contact
    contact_page_title: "Contact — Église de Dieu de la Prophétie de Carrefour",
    ...
    contact_sunday: "Dimanche", contact_tuesday: "Mardi", contact_thursday: "Jeudi",
    ...
    contact_email_label: "Adresse email *", contact_phone_label: "Téléphone (optionnel)",
    contact_subject_label: "Sujet *", contact_subject_choose: "-- Choisissez un sujet --",
    contact_subject_info: "Informations générales", contact_subject_prayer: "Demande de prière",
    contact_subject_visit: "Première visite", contact_subject_don: "Don & offrande",
    contact_subject_other: "Autre", contact_message_label: "Votre message *",
    ...
    actu_filter_label: "Filtrer :", actu_filter_all: "Tout", actu_filter_events: "Événements",
    actu_filter_annonces: "Annonces", actu_filter_spiritual: "Spirituel",
    ...
    actu_read_more: "Lire plus", actu_newsletter_title: "Restez informés",
    actu_newsletter_text: "Recevez nos actualités, annonces et messages d'encouragement directement par email.",
    actu_email_ph: "Votre adresse email", actu_subscribe: "S'abonner",
    actu_close: "Fermer", actu_subscribed: "Merci ! Vous êtes abonné(e). Que Dieu vous bénisse !",
    articles: {
  ...
  en: {
    lang: "en",
    nav_accueil: "Home", nav_apropos: "About", nav_horaires: "Service Times",
    nav_galerie: "Gallery & Videos", nav_actualites: "News", nav_temoignages: "Testimonies",
    nav_contact: "Contact", nav_priere: "Prayer Request", nav_don: "Give",
    header_subtitle: "Carrefour, waney 93",
    header_verse: "\"I can do all things through Christ who strengthens me\" — Phil. 4:13",
    slide1: "Pastor Anouis Jean", slide2: "Pastor Honore Pierre Jolius",
    slide3: "Sister Woodeline in prayer", slide4: "Evangelist Guerrier Michel",
    slide5: "Pastor Anouis Jean", slide6: "Pastor Honore Pierre Jolius",
    slide7: "Evangelist Tidot Ameus", slide8: "Pastor Anouis Jean",
    ...
    quick_priere_title: "Prayer Request", quick_priere_text: "Submit your prayer requests",
    quick_temo_title: "Testimonies", quick_temo_text: "Share what God has done",
    quick_actu_title: "News", quick_actu_text: "Latest church news",
    quick_galerie_title: "Gallery", quick_galerie_text: "Photos and videos of our services",
    annonces_title: "Announcements",
    annonce1_title: "Night Vigil", annonce1_date: "Friday — 8:00 PM",
    annonce2_title: "Youth Meeting", annonce2_date: "Sunday afternoon — 4:00 PM",
    annonce3_title: "Main Service", annonce3_date: "Sunday — 6:00 AM to 10:00 AM",
    ...
    don_title: "Support our ministry", don_text: "Your generosity helps us continue our evangelistic mission.", don_btn: "Give",
    footer_nav_title: "Navigation", footer_community_title: "Community", footer_find_title: "Find us",
    footer_rights: "© 2025 Church of God of Prophecy of Carrefour waney 93 — All rights reserved",
    contact_page_title: "Contact — Church of God of Prophecy of Carrefour",
    contact_badge: "Contact us", contact_hero_title: "We are here for you",
    contact_hero_text: "A question, a testimony or need support? Our team is available for you.",
    contact_address_title: "Our address", contact_phone_title: "Phone",
    contact_email_title: "Email", contact_social_title: "Social media",
    contact_facebook: "Facebook — Church of Carrefour", contact_youtube: "YouTube — Live services",
    contact_schedule_title: "Service schedule",
    contact_sunday: "Sunday", contact_tuesday: "Tuesday", contact_thursday: "Thursday",
    contact_form_title: "Send us a message",
    contact_form_subtitle: "We will reply as soon as possible. God bless you!",
    contact_firstname: "First name *", contact_lastname: "Last name *",
    contact_email_label: "Email address *", contact_phone_label: "Phone (optional)",
    contact_subject_label: "Subject *", contact_subject_choose: "-- Choose a subject --",
    contact_subject_info: "General information", contact_subject_prayer: "Prayer request",
    contact_subject_visit: "First visit", contact_subject_don: "Donation & offering",
    contact_subject_other: "Other", contact_message_label: "Your message *",
    contact_message_ph: "Write your message here...", contact_send_btn: "Send message",
    ...
    actu_filter_label: "Filter:", actu_filter_all: "All", actu_filter_events: "Events",
    actu_filter_annonces: "Announcements", actu_filter_spiritual: "Spiritual",
    ...
    actu2_text: "All ministry leaders are invited to an important meeting on June 20 at 6 PM. Attendance mandatory.",
    ...
    actu_read_more: "Read more", actu_newsletter_title: "Stay informed",
    actu_newsletter_text: "Receive our news, announcements and encouragement messages directly by email.",
    actu_email_ph: "Your email address", actu_subscribe: "Subscribe",
    actu_close: "Close", actu_subscribed: "Thank you! You are subscribed. God bless you!",
    articles: {
    ...
    footer_priere: "Prayer Request", footer_temo: "Testimonies", footer_galerie: "Gallery", footer_don: "Give",
  },
  es: {
    lang: "es",
    nav_accueil: "Inicio", nav_apropos: "Acerca de", nav_horaires: "Horarios de culto",
    nav_galerie: "Galería & Videos", nav_actualites: "Noticias", nav_temoignages: "Testimonios",
    nav_contact: "Contacto", nav_priere: "Solicitud de oración", nav_don: "Donar",
    header_subtitle: "Carrefour, waney 93",
    header_verse: "\"Todo lo puedo en Cristo que me fortalece\" — Fil. 4:13",
    slide1: "Pastor Anouis Jean", slide2: "Pastor Honore Pierre Jolius",
    slide3: "Hermana Woodeline en oración", slide4: "Evangelista Guerrier Michel",
    slide5: "Pastor Anouis Jean", slide6: "Pastor Honore Pierre Jolius",
    slide7: "Evangelista Tidot Ameus", slide8: "Pastor Anouis Jean",
    ...
    quick_priere_title: "Solicitud de oración", quick_priere_text: "Envíe sus peticiones de oración",
    quick_temo_title: "Testimonios", quick_temo_text: "Comparte lo que Dios ha hecho",
    quick_actu_title: "Noticias", quick_actu_text: "Últimas noticias de la iglesia",
    quick_galerie_title: "Galería", quick_galerie_text: "Fotos y videos de nuestros cultos",
    annonces_title: "Anuncios",
    annonce1_title: "Vigilia nocturna", annonce1_date: "Viernes — 8:00 PM",
    annonce2_title: "Reunión de jóvenes", annonce2_date: "Domingo tarde — 4:00 PM",
    annonce3_title: "Culto principal", annonce3_date: "Domingo — 6:00 AM a 10:00 AM",
    ...
    don_title: "Apoya nuestro ministerio", don_text: "Su generosidad nos ayuda a continuar nuestra misión evangelística.", don_btn: "Donar",
    footer_nav_title: "Navegación", footer_community_title: "Comunidad", footer_find_title: "Encuéntranos",
    footer_rights: "© 2025 Iglesia de Dios de la Profecía de Carrefour waney 93 — Todos los derechos reservados",
    contact_page_title: "Contacto — Iglesia de Dios de la Profecía de Carrefour",
    contact_badge: "Contáctenos", contact_hero_title: "Estamos aquí para usted",
    contact_hero_text: "¿Una pregunta, un testimonio o necesita apoyo? Nuestro equipo está disponible.",
    contact_address_title: "Nuestra dirección", contact_phone_title: "Teléfono",
    contact_email_title: "Correo electrónico", contact_social_title: "Redes sociales",
    contact_facebook: "Facebook — Iglesia de Carrefour", contact_youtube: "YouTube — Cultos en vivo",
    contact_schedule_title: "Horarios de culto",
    contact_sunday: "Domingo", contact_tuesday: "Martes", contact_thursday: "Jueves",
    contact_form_title: "Envíenos un mensaje",
    contact_form_subtitle: "Le responderemos lo antes posible. ¡Que Dios le bendiga!",
    contact_firstname: "Nombre *", contact_lastname: "Apellido *",
    contact_email_label: "Correo electrónico *", contact_phone_label: "Teléfono (opcional)",
    contact_subject_label: "Asunto *", contact_subject_choose: "-- Elija un asunto --",
    contact_subject_info: "Información general", contact_subject_prayer: "Solicitud de oración",
    contact_subject_visit: "Primera visita", contact_subject_don: "Donación & ofrenda",
    contact_subject_other: "Otro", contact_message_label: "Su mensaje *",
    contact_message_ph: "Escriba su mensaje aquí...", contact_send_btn: "Enviar mensaje",
    ...
    actu_filter_label: "Filtrar:", actu_filter_all: "Todo", actu_filter_events: "Eventos",
    actu_filter_annonces: "Anuncios", actu_filter_spiritual: "Espiritual",
    actu1_title: "Culto Especial de Pentecostés",
    actu1_text: "Únase a nosotros para un culto especial celebrando Pentecostés con invitados especiales.",
    actu2_title: "Reunión de Líderes — 20 de Junio",
    actu2_text: "Todos los líderes de ministerios están invitados a una reunión importante el 20 de junio. Asistencia obligatoria.",
    actu3_title: "Nueva Serie: El Poder de la Oración",
    actu3_text: "Este domingo comienza una nueva serie de mensajes sobre \"El Poder de la Oración Perseverante\".",
    actu4_title: "Conferencia Anual — Julio 2025",
    actu4_text: "Una semana de enseñanza y avivamiento con oradores invitados.",
    actu5_title: "Dedicación de Niños — Julio",
    actu5_text: "Los padres que deseen dedicar a sus hijos al Señor pueden inscribirse con los pastores.",
    actu6_title: "Ayuno y Oración — 3 Días",
    actu6_text: "Nuestra iglesia organiza un período de ayuno y oración de 3 días para interceder por Haití.",
    actu_read_more: "Leer más", actu_newsletter_title: "Manténgase informado",
    actu_newsletter_text: "Reciba nuestras noticias y mensajes de aliento directamente por correo electrónico.",
    actu_email_ph: "Su dirección de correo electrónico", actu_subscribe: "Suscribirse",
    actu_close: "Cerrar", actu_subscribed: "¡Gracias! Estás suscrito(a). ¡Que Dios te bendiga!",
    articles: {
      ...
      jeune: { tag:'Espiritual', titre:'Ayuno y Oración — 3 Días', date:'20 de Mayo 2025', auteur:'Grupo de Intercesión', cat:'Espiritual', intro:"Nuestra iglesia organiza un período de ayuno y oración colectiva de 3 días para interceder por Haití.", contenu:`<p><strong>• Día 1:</strong> Intercesión por Haití — paz y restauración.</p><p><strong>• Día 2:</strong> Oración por nuestras familias — unidad y protección.</p><p><strong>• Día 3:</strong> Avivamiento espiritual.</p>`, details:[{icon:'fa-calendar',label:'Fechas',valeur:'3 días consecutivos — anunciados en culto'},{icon:'fa-clock',label:'Reuniones',valeur:'Cada noche a las 6:30 PM'},{icon:'fa-map-marker-alt',label:'Lugar',valeur:'Iglesia de Dios de la Profecía — Carrefour'},{icon:'fa-hands-praying',label:'Participación',valeur:"Abierto a todos los miembros"}], bouton:{label:'Solicitud de oración',lien:'priere.html',icon:'fa-hands-praying'} },
    },
    footer_priere: "Solicitud de oración", footer_temo: "Testimonios", footer_galerie: "Galería", footer_don: "Donar",
  },
  ht: {
    lang: "ht",
    nav_accueil: "Akèy", nav_apropos: "Konsènan nou", nav_horaires: "Orè kilt yo",
    nav_galerie: "Galeri & Videyo", nav_actualites: "Aktyalite", nav_temoignages: "Temwayaj",
    nav_contact: "Kontakte", nav_priere: "Demann priyè", nav_don: "Fè yon don",
    header_subtitle: "Kafou, waney 93",
    header_verse: "\"Mwen kapab fè tout bagay nan Kris ki ban mwen fòs\" — Fil. 4:13",
    slide1: "Pastè Anouis Jean", slide2: "Pastè Honore Pierre Jolius",
    slide3: "Sè Woodeline nan priyè", slide4: "Evanjelis Guerrier Michel",
    slide5: "Pastè Anouis Jean", slide6: "Pastè Honore Pierre Jolius",
    slide7: "Evanjelis Tidot Ameus", slide8: "Pastè Anouis Jean",
    ...
    quick_priere_title: "Demann priyè", quick_priere_text: "Soumèt demann priyè ou yo",
    quick_temo_title: "Temwayaj", quick_temo_text: "Pataje sa Bondye te fè",
    quick_actu_title: "Aktyalite", quick_actu_text: "Dènye nouvèl legliz la",
    quick_galerie_title: "Galeri", quick_galerie_text: "Foto ak videyo kilt nou yo",
    annonces_title: "Anons",
    annonce1_title: "Vèy lannwit", annonce1_date: "Vandredi — 8è diswa",
    annonce2_title: "Reyinyon jèn yo", annonce2_date: "Dimanch apremidi — 4è",
    annonce3_title: "Kilt prensipal", annonce3_date: "Dimanch — 6è a 10è maten",
    ...
    don_title: "Sipòte ministè nou an", don_text: "Jenerozite ou ede nou kontinye misyon evanjelik nou an.", don_btn: "Fè yon don",
    footer_nav_title: "Navigasyon", footer_community_title: "Kominote", footer_find_title: "Jwenn nou",
    footer_rights: "© 2025 Legliz Bondye Pwofesi Kafou waney 93 — Tout dwa rezève",
    contact_page_title: "Kontakt — Legliz Bondye Pwofesi Kafou",
    contact_badge: "Kontakte nou", contact_hero_title: "Nou la pou ou",
    contact_hero_text: "Yon kesyon, yon temwayaj oswa bezwen sipò? Ekip nou an disponib pou ou.",
    contact_address_title: "Adrès nou", contact_phone_title: "Telefòn",
    contact_email_title: "Imèl", contact_social_title: "Rezo sosyal",
    contact_facebook: "Facebook — Legliz Kafou", contact_youtube: "YouTube — Kilt an dirèk",
    contact_schedule_title: "Orè kilt yo",
    contact_sunday: "Dimanch", contact_tuesday: "Madi", contact_thursday: "Jedi",
    contact_form_title: "Voye nou yon mesaj",
    contact_form_subtitle: "Nou ap reponn ou pi vit posib. Ke Bondye beni ou!",
    contact_firstname: "Prenon *", contact_lastname: "Non *",
    contact_email_label: "Adrès imèl *", contact_phone_label: "Telefòn (opsyonèl)",
    contact_subject_label: "Sijè *", contact_subject_choose: "-- Chwazi yon sijè --",
    contact_subject_info: "Enfòmasyon jeneral", contact_subject_prayer: "Demann priyè",
    contact_subject_visit: "Premye vizit", contact_subject_don: "Don & ofrann",
    contact_subject_other: "Lòt", contact_message_label: "Mesaj ou *",
    contact_message_ph: "Ekri mesaj ou isit la...", contact_send_btn: "Voye mesaj la",
    ...
    actu_filter_label: "Filtre:", actu_filter_all: "Tout", actu_filter_events: "Evènman",
    actu_filter_annonces: "Anons", actu_filter_spiritual: "Espirityèl",
    ...
    actu2_text: "Tout lidè ministè yo envite nan yon reyinyon enpòtan 20 jen a 6è diswa. Prezans obligatwa.",
    actu3_title: "Nouvo Seri: Pouvwa Priyè a",
    actu3_text: "Dimanch sa a kòmanse yon nouvo seri mesaj sou \"Pouvwa Priyè Pèseveran an\". Pa rate randevou sa a!",
    actu4_title: "Konferans Anyèl — Jiyè 2025",
    actu4_text: "Yon semèn ansèyman ak revèy ak oratè envite. Pwogram konplè disponib nan legliz la.",
    ...
    actu_read_more: "Li plis", actu_newsletter_title: "Rete enfòme",
    actu_newsletter_text: "Resevwa aktyalite nou yo ak mesaj ankourajman dirèkteman pa imèl.",
    actu_email_ph: "Adrès imèl ou", actu_subscribe: "Abòne",
    actu_close: "Fèmen", actu_subscribed: "Mèsi! Ou abòne. Ke Bondye beni ou!",
    articles: {
    ...
    footer_priere: "Demann priyè", footer_temo: "Temwayaj", footer_galerie: "Galeri", footer_don: "Fè yon don",
  }
};
